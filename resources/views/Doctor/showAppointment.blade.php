...
@section('pageHeader', 'Appointment Information')
            ...
            <div class="col">
                ...
                <div class="card mb-4  shadow">
                    <div class="card-header border-0"
                        ...
                        <span class="ml-2">Show {{ $appointment->apppatient->patient->hasta_adi }} information</span>
                        <span class="pull-right">Havencare ID : {{ $appointment->apppatient->id}}</span>
                    </div>
                    <div class="card-body">
                        <div class="row g-2">
                            <div class="col-md">
