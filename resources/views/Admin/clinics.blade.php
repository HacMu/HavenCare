...
<!--Set title of page as Clinics-->
@section('title', 'Clinics')
<!--Set header of page as Clinics Management-->
            ...
            <div class="col">
                ...
                <div class="card mb-4  shadow">
                    <div class="card-header border-0"
                        ...
                        <span class="ml-2">Havencare clinics information</span>
                    </div>
                    <div class="card-body">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex justify-content-center">
                                                ...
                                                <a href="{{ route('admin.edit.clinic', $clinic->id) }}"
                                                    class="navbar-brand mr-2"><i style="color: #00a099;font-size:14pt"
                                                        class="fa-solid fa-pen-to-square "></i>
                                                </a>
                                                <a href="#"class="navbar-brand">
                                                    <form action="{{ route('admin.delete.clinic', $clinic->id) }}"
                                                        method="POST">
                                                        @csrf
                                                        @method('DELETE')
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header d-flex justify-content-center border-0 shadow-sm" >
                    <b class="modal-title fs-5 fs-4 pull-center" id="article">Add new clinic</b>
                </div>
                <form action="{{ route('admin.new.clinic') }}" method="POST">
                    @csrf
                            ...
                            <div class="col-md">
                                <div class="form-floating mb-3">
                                    <input type="text" class="form-control bg-light border-0 shadow-sm  rounded"
                                        id="floatingInput" name="klinik_adi" placeholder="#" required>
                            ...
                            <div class="col-md">
                                <div class="form-floating mb-3">
                                    <input type="number" class="form-control bg-light border-0 shadow-sm  rounded"
                                        id="floatingInput" name="klinik_numarasi" placeholder="#" required>
