...
@section('title', 'Show - Out-Patient')
<!--Set header of page as Patient Management panel-->
@section('pageHeader', 'Out-Patient Information')
            ...
            <div class="col">
                ...
                <div class="card mb-4  shadow">
                    <div class="card-header border-0"
                        ...
                        <span class="ml-2">Show Out-Patient information</span>
                            ...
                            <div class="col-md">
                                <div class="form-floating mb-3">
                                    <input type="text" name="oda_id"
                                        class="form-control bg-light border-0 shadow-sm  rounded" id="floatingInput"
                                        readonly name="id" placeholder="#"
                                        value="{{ $patient->inRoom->department->bolum_adi}}  {{ $patient->inRoom->oda_adi }} No : {{ $patient->inRoom->oda_numarasi }}" required>
                            ...
                            <div class="col-md">
                                <div class="form-floating mb-3">
                                    <input type="text" name="id"
                                        class="form-control bg-light border-0 shadow-sm  rounded" id="floatingInput"
                                        readonly name="id" placeholder="#"
                                        value="{{ $patient->inDoctor->id}}" required>
                            ...
                            <div class="col-md">
                                <div class="form-floating mb-3">
                                    <input type="text" name="bolum_adi"
                                        class="form-control bg-light border-0 shadow-sm  rounded" id="floatingInput"
                                        readonly name="id" placeholder="#"
                                        value="{{ $patient->inDoctor->doctor->clinic->department->bolum_adi}}" required>
                            ...
                            <div class="col-md">
                                <div class="form-floating mb-3">
                                    <input type="text" name="oda_id"
                                        class="form-control bg-light border-0 shadow-sm  rounded" id="floatingInput"
                                        readonly name="id" placeholder="#"
                                        value="{{$patient->inDoctor->doctor->clinic->klinik_adi}} NO : {{$patient->inDoctor->doctor->clinic->klinik_numarasi}} " required>
