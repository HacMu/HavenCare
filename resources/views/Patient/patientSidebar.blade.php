<aside class="sidebar" id="sidebar">
    <div id="leftside-navigation" class="nano">
        ...
        <ul class="nano-content">
            <li>
                <a href="{{route('patient.profile')}}"><i class="fa fa-dashboard"></i><span>Profile</span></a>
            </li>
            <li class="sub-menu">
                <a href="{{route('patient.appointment')}}"><i class="fa-solid fa-calendar-check"></i></i><span>Appointments</span>
                </a>
            </li>
            <li class="sub-menu">
